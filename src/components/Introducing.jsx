...
const Introducing = () => {
  return (
    <div className='mt-20 mb-60 lg:mb-24 px-10 sm:px-3 lg:mx-20'>
        <div className='bg-[url("https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/Highlight-Multi-Canvas-Bing-AI-No-Text:VP5-1596x600")] h-[200px] lg:h-[545px] bg-cover bg-center lg:pl-[80px] xl:pl-[117px] pt-80 lg:pt-36 lg:pr-[550px] xl:pr-[570px] 2xl:pr-[755px]'>
            <div className='text-black '>
                <h1 className='text-3xl sm:text-[37px] lg:text-white'>Introducing the new Bing</h1>
                ...
                <button className='bg-[#0067B8] hover:bg-[#0067D8] text-white font-bold p-2 mt-2 mb-3'>Join the Bing preview</button>
                <a href="" className='no-underline hover:underline lg:text-white lg:hover:text-white'><p className='flex'><span className='hover:mr-1'>Learn about the new Bing in Windows</span><FaChevronRight className='mt-1 ml-1' /></p></a>
            </div>
        </div>
    </div>
  )
