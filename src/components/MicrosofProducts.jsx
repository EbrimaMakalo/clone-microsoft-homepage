...
const MicrosofProducts = () => {
  return (
    <div className='mt-32 mb-16 md:mx-10 lg:mx-20 2xl:mx-36'>
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 text-center text-[15px] justify-between'>
            <div>
                <img src={imagecategory1} className='pl-24' alt="" />
                <p><a href="">Shop Surface devices</a></p>
            </div>
            <div>
                <img src={imagecategory2} className='pl-24' alt="" />
                <a href=""><p>Choose your Microsoft 365</p></a>            
            </div>
            <div>
                <img src={imagecategory3} className='pl-24' alt="" />
            ...
            <div>
                <img src={imagecategory4} className='pl-24' alt="" />
                <a href=""><p>Shop for accessories</p></a>            
            </div>
            <div>
                <img src={imagecategory5} className='pl-24' alt="" />
